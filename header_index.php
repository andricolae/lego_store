...
<style>
    *{margin:1%;}
    #header{background:#f2d974;width:100%;height:150px;}
    #header img{width:125px;height:125px;border-radius:5px;}
    #header h1{text-align:left;margin-left:200px;margin-top:-125px;color:#000000;}
    #header ul li{float:right;margin-right:20px;font-size:20px;margin-top:-30px;}
    #header ul li a{color:black;text-decoration:none;}
</style>
</head>
